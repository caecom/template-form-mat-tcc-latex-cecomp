...
% IDENTIFICAÇÃO
% ---------------------------------------------------------------------------
\titulo{Análise do impacto de variáveis de Recuperação de Informação no desempenho de classificadores de Mineração de Textos}
...
\tipotrabalho{Formulário de matrícula de TCC I}
